...
KIMI_MODELS = ["kimi-k2.7-code", "kimi-k2.7-code-highspeed", "kimi-for-coding", "kimi-k2.6", "kimi-k2.5"]
...
async def get_settings(request: Request, username: str = Depends(get_current_user)):
    ...
    return SettingsResponse(
        ...
        kimi_model=config.get("kimi_model", "kimi-k2.7-code"),
...
async def update_settings(
    ...
    for key in ["deepseek_api_key", "deepseek_model", "deepseek_timeout"]:
...
async def test_kimi(
    ...
    model = _pick(body.kimi_model, config.get("kimi_model", "kimi-k2.7-code"))
